    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('products.store') }}">
            ...
            <div>
                ...
                <x-input id="product_name" class="block mt-1 w-full" type="text" name="product_name" :value="old('product_name')" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="product_desc" class="block mt-1 w-full" type="text" cols=50 rows=6 name="product_desc" :value="old('product_desc')" required />
            </div>
