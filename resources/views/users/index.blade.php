    ...
    <div class="py-12">
        ...
        <form method="SUBMIT" action="{{ route('users.edit', $user_info, $address_info)}}">
            ...
            <div>
                ...
                <x-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$user_info->name}}" required autofocus readonly/>
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" value="{{$user_info->email}}" required readonly/>
            </div>
